...
Rails.application.routes.draw do
  ...
  constraints NewDesignSystemConstraint.new do
    resources :editions do
      member do
        ...
        get "tagging_mainstream_browse_pages_page", to: "tagging#mainstream_browse_pages_page"
        get "tagging_related_content_page", to: "tagging#related_content_page"
        get "tagging_reorder_related_content_page", to: "tagging#reorder_related_content_page"
        get "tagging_organisations_page", to: "tagging#organisations_page"
        get "tagging_breadcrumb_page", to: "tagging#breadcrumb_page"
        get "tagging_remove_breadcrumb_page", to: "tagging#remove_breadcrumb_page"
        get "unpublish"
  ...
  resources :editions, only: [] do
    member do
      ...
      post "back_to_send_to_fact_check_page", action: :send_to_fact_check_page
