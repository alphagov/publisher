...
module Workflow
  ...
  def denormalise_users!
    ...
    new_record? ? self.assignee = new_assignee : update_column(:assignee, new_assignee) unless new_assignee == assignee
    update_column(:assignee, new_assignee) unless new_assignee == assignee || new_record?
