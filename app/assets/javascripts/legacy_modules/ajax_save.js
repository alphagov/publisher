...
(function (Modules) {
  ...
  Modules.AjaxSave = function () {
    this.start = function (element) {
      ...
      element.on('success.ajaxsave.admin', parts_success)
      element.on('errors.ajaxsave.admin', parts_error)
      ...
      function error (response, textStatus, errorThrown) {
        ...
        if (responseJSON.hasOwnProperty("parts")) {
          parts_error('errors.ajaxsave.admin', response)
        } else {
      ...
      // parts functions
      function parts_error (evt, response) {
        var responseJSON = response.responseJSON
      ...
      function parts_success (evt, response) {
