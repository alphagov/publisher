...
;(function (Modules) {
  Modules.Ga4SearchResultsSetup = {
    init: function (noHashChange) {
      ...
      console.log('data-ga4-ecommerce: ', document.querySelector('[data-ga4-ecommerce]'))
      ...
      // Not sure if this is relevant for publisher but leaving it here for now
    ...
    addSearchResultLinkTracking: function () {
      console.log('addSearchResultLinkTracking!')
      ...
      document.querySelectorAll('[data-ga4-ecommerce]').forEach((container) => {
        ...
        table.querySelectorAll('tbody tr').forEach((row, rowIndex) => {
          // the links in the title column are the links that we want to track
          row
    ...
    trackEcommerce: function () {
      ...
      // is visible
      // Don't think this is relevant for publisher
      ...
      console.log('govuk-tabs: ', document.querySelector('[data-module~="govuk-tabs"]'))

      if (!searchTarget && document.querySelector('[data-module~="govuk-tabs"]')) {
        if (hash.length) {
