...
class CsvReportGenerator
  ...
  def presenters
    two_yrs_ago = 2.years.ago.at_beginning_of_day
    ...
    @presenters ||= [
      ...
      RecentContentWorkflowPresenter.new(Edition.where(updated_at: two_yrs_ago..current_time)
                                                .or(Edition.where(created_at: two_yrs_ago..current_time)).order(created_at: :desc)),
