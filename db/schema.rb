...
ActiveRecord::Schema[7.1].define(version: 2025_04_23_150928) do
  ...
  create_table "variants", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "transaction_edition_id"
    t.index ["transaction_edition_id"], name: "index_variants_on_transaction_edition_id"
  end
  ...
  add_foreign_key "variants", "transaction_editions"
end
