...
ActiveRecord::Schema[7.1].define(version: 2024_12_11_110046) do
  ...
  create_table "editions", force: :cascade do |t|
    ...
    t.string "auth_bypass_id", default: "aa04727c-854e-42b8-beb3-39c7b628717b"
    ...
    t.index ["panopticon_id"], name: "index_editions_on_panopticon_id"
    t.index ["version_number"], name: "index_editions_on_version_number"
  end
  ...
  create_table "parts", force: :cascade do |t|
    ...
    t.string "body"
    t.string "slug"
    t.datetime "created_at", default: "2025-01-02 14:38:53"
