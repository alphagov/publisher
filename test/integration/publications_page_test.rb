...
class PublicationsPageTest < IntegrationTest
  ...
  context "fact-check page" do
    setup do
      ...
      @other_user_returned_edition = FactoryBot.create(:edition, :fact_check_received, title: "Other User's edition", assigned_to: @other_user, received_at: 32.days.ago)
      ...
      @other_user_awaiting_response_edition = FactoryBot.create(:edition, :fact_check, title: "Other User's edition", assigned_to: @other_user, sent_out_at: 32.days.ago)
