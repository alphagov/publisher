...
class EditionEditTest < IntegrationTest
  ...
  context "Send to 2i page" do
    ...
    should "show success message and redirects back to the edit tab when Send to 2i button is pressed" do
      fill_in "comment", with: "This is a note for 2i"
      click_button "Send to 2i"

      # TODO: - Do we need to check the action is stored, and/or is visible on History and notes?
      # The comment storage is tested in edition_controller_test line 387
      assert_current_path edition_path(@draft_edition.id)
