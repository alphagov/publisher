  ...
  context "History and notes tab" do
    ...
    context "Edition displays the correct data for actions" do
      setup do
        ...
        user_2 = FactoryBot.create(:user, name: "David Phillips")
        user_3 = FactoryBot.create(:user, name: "Greg Downs")
        user_4 = FactoryBot.create(:user, name: "Lloyd McGrath")
      ...
      should "display 'Assign' action" do
        ...
        within :css, ".action--assign__content" do
