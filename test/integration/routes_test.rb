...
class RoutesTest < LegacyIntegrationTest
  ...
  context "new design system" do
    ...
    context "allowed content types" do
      %i[answer_edition help_page_edition place_edition].each do |content_type|
    ...
    context "not allowed content types" do
      %i[guide_edition local_transaction_edition completed_transaction_edition simple_smart_answer_edition transaction_edition].each do |content_type|
        context content_type do
          setup do
