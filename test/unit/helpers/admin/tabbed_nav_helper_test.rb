...
class TabbedNavHelperTest < ActionView::TestCase
  test "#secondary_navigation_tabs_items for draft edition edit page when user has editor access" do
    ...
    assert_equal expected_output, edition_nav_items(resource, user)
  end

  test "#secondary_navigation_tabs_items for published edition edit page when user has editor access" do
    user = FactoryBot.create(:user, :govuk_editor, name: "Stub User")
  ...
  test "#secondary_navigation_tabs_items for draft edition edit page when user has no editor access" do
  ...
  test "#secondary_navigation_tabs_items for published edition edit page when user has no editor access" do
    user = FactoryBot.create(:user, name: "Stub User")
    resource = FactoryBot.create(:guide_edition, title: "Edit page title", state: "published")
