...
class AnswerPresenterTest < ActiveSupport::TestCase
  ...
  context ".render_for_publishing_api with a published document" do
    setup do
      artefact = FactoryGirl.create(:artefact, kind: "answer", slug: "answer")
      ...
      @edition = FactoryGirl.create(:answer_edition, :published,
        major_change: true,
      ...
      @presenter = Formats::AnswerPresenter.new(@edition)
    ...
    should "create an attributes hash for the publishing api for a republish" do
      ...
      assert_valid_against_schema(presented_hash, 'answer')
    end
    ...
    should 'always return a "major" update_type for a first edition' do
      ...
      presenter = Formats::AnswerPresenter.new(first_edition)
  ...
  context ".render_for_publishing_api with a draft document" do
    setup do
      ...
      @output = Formats::AnswerPresenter.new(@edition).render_for_publishing_api
    end

    should "be valid against schema" do
      assert_valid_against_schema(@output, 'answer')
    end
