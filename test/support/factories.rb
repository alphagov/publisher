...
FactoryBot.define do
  STATE_TRAITS = %i[published draft archived scheduled_for_publishing ready fact_check fact_check_received in_review].freeze
  ...
  #     authority_type { "local_authority_service"}
