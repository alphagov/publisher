...
FactoryBot.define do
  ...
  factory :local_transaction_edition, class: "Edition" do
    ...
    editionable do
      build(:create_local_transaction,
            lgil_code:, lgsl_code:, introduction:, cta_text:, more_information:, need_to_know:, before_results:, after_results:,
            scotland_availability:, wales_availability:, northern_ireland_availability:)
    end
