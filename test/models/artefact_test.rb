...
class ArtefactTest < ActiveSupport::TestCase
  ...
  context "#need_ids" do
    should "be empty by default" do
      assert_empty FactoryBot.build(:artefact).need_ids
    end

    should "do validations if nil" do
      artefact = FactoryBot.create(:artefact, need_ids: ["100001"])
