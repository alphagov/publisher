...
class HostContentUpdateEvent::ActionTest < ActiveSupport::TestCase
  ...
  let(:host_content_update_event) { FactoryBot.build(:host_content_update_event, document_type: "Email address", content_id:) }
  ...
  it "returns a duck-typed representation of an Action" do
    assert_equal action.request_type, HostContentUpdateEvent::Action::REQUEST_TYPE
