...
class WorkflowTest < ActiveSupport::TestCase
  ...
  test "permits the creation of new editions" do
    ...
    reloaded_transaction = TransactionEdition.find(transaction.editionable.id)
    new_edition = user.new_version(reloaded_transaction.edition)
  ...
  test "a programme should be marked as having reviewables if requested for review" do
    ...
    assert_not guide.in_review?
    request_review(user, guide)
    assert guide.in_review?, "A review was not requested for this programme."
  end
