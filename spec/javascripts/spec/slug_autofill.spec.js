...
describe('A slug autofill module', function () {
  ...
  describe('when title-input-id and slug-input-id data attributes are set', function () {
    const formHtml = `
      <form>
  ...
  describe('when title-input-id and slug-input-id data attributes are not set', function () {
    const formHtml = `
      <form>
